 ...
 */
package com.embecta.test.setup;
...
import com.embecta.test.constants.EmbectaTestConstants;
import com.embecta.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = EmbectaTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/embectatest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/embectatest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/embectatest/import/cstickets.impex");
			...
			importImpexFile(context, "/embectatest/import/csquotes.impex");
		}
	}
}
