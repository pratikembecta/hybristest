 ...
 */
package com.embecta.core.constants;

/**
 * Global class for all EmbectaCore constants. You can add global constants for your extension into this class.
 */
public final class EmbectaCoreConstants extends GeneratedEmbectaCoreConstants
{
	public static final String EXTENSIONNAME = "embectacore";


	private EmbectaCoreConstants()
	{
		//empty
	}
