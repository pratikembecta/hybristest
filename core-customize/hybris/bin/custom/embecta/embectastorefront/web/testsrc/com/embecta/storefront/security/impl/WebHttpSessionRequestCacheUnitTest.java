...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/embectastorefront/electronics/en",
						"https://electronics.local:9002/embectastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/embectastorefront/electronics/en",
						"https://electronics.local:9002/embectastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/embectastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/embectastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/embectastorefront/electronics/en",
						"https://electronics.local:9002/embectastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/embectastorefront",
						"https://electronics.local:9002/embectastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/embectastorefront",
						"https://electronics.local:9002/embectastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/embectastorefront/electronics/en",
						"https://electronics.local:9002/embectastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
